...
public class TaciStatusBar extends JPanel {
	...
	public TaciStatusBar() {
		setSize(J_WIDTH - 15, MOVE_DISTANCE * 3/2);
		setBorder(BorderFactory.createTitledBorder(STATUS_BAR_TITLE));
		setLayout(null);
		setLocation(0, J_HEIGHT - MOVE_DISTANCE * 6 / 3);

		jlbCloses = new JLabel();
		jlbCloses.setSize(400, 20);
		jlbCloses.setLocation(10 + MOVE_DISTANCE * 2, 20);
		jlbCloses.setText(String.format(STATUS_BAR_CLOSED_NUMBER, 0));

		jlbOpens = new JLabel();
		jlbOpens.setSize(400, 20);
		jlbOpens.setLocation(10 + MOVE_DISTANCE * 2, 60);
		jlbOpens.setText(String.format(STATUS_BAR_OPENED_NUMBER, 0));

		jlbTimeCost = new JLabel();
		jlbTimeCost.setSize(400, 20);
		jlbTimeCost.setLocation(200 + MOVE_DISTANCE * 2, 20);
		jlbTimeCost.setText(String.format(STATUS_BAR_TIME_COST, 0.0));

		jlbSteps = new JLabel();
		jlbSteps.setSize(400, 20);
		jlbSteps.setLocation(200 + MOVE_DISTANCE * 2, 60);
		jlbSteps.setText(String.format(STATUS_BAR_STEPS_NUMBER, 0));
		
		jlbCurrentStatus = new JLabel();
		jlbCurrentStatus.setSize(400, 20);
		jlbCurrentStatus.setLocation(200 + MOVE_DISTANCE * 4, 20);
		...
		jlbCurrentSwappingSpeed.setLocation(200 + MOVE_DISTANCE * 4, 60);
